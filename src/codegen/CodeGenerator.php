...
class CodeGenerator implements Visitor
{
    ...
    public function __construct($parserName, $namespace = "")
    {
        ...
        $this->headerCommentFile = "";
        $this->content = [];
        $this->elemStack = [];
    }

    public function setHeaderCommentFile($filePath)
    {
        $this->headerCommentFile = $filePath;
    }
    ...
    public function generate(Ast $grammar, Output $output=null)
    {
        ...
        if (empty($this->headerCommentFile)) {
            $comment = <<<COMMENT
...
COMMENT;
            ...
            $comment = file_get_contents($this->headerCommentFile);
        }
